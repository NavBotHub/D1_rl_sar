...
)
{
    ...
    // Limit backward motion to -0.6 (align with training max_backward_curriculum and avoid extrapolated crouching at full backward stick deflection)
...
void RL_Sim::RunModel()
{
    if (this->rl_init_done && simulation_running)
    {
        ...
        this->obs.commands = rl_command::ClampCommands(this->obs.commands);
